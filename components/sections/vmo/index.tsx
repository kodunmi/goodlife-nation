            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-7 '>
            {
                vmoList.map((vmo, index) => {
                    return (
                            ...
                            <div className="relative flex flex-col items-center justify-around p-4  h-80 rounded-2xl " style={{ transform:' translate(0px, 0px)', opacity: 1 }}>
                            ...
                            <div className="z-10 p-2 text-blue-900">
                                ...
                                <div className="z-10 p-2 text-sm text-center text-gray-500 dark:!text-slate-200">
                                    {vmo.description}
                                    </div>
                                </div>
