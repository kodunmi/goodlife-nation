            ...
            <div className='px-4 sm:px-8 mb-16'>
                <div className="w-full px-4 pt-16">
                    ...
                    <ol className="relative border-l border-gray-200 dark:border-gray-700">
                        ...
                        <li className="mb-10 ml-4">
                            <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                            <time className="mb-1 text-3xl font-normal leading-none text-blue-400">2021 - Our Year Of Divine Presence</time>
                        </li>
                        ...
                        <li className="mb-10 ml-4">
                            <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                            <time className="mb-1 text-3xl font-normal leading-none text-blue-400">2020 - Our Year Of </time>
                        </li>
